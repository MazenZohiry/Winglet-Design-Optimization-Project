function [J,CDi,M_total] = Cost_function(x, x0, k, CDi0, M_T0, Aero, wing, simplified )
...
% 	winglet.lw =  0.7;				%winglet root chord length in %
% 	winglet.phi = 40;				%winglet taper
% 	winglet.Cwr =  0.8;				%winglet root chord length in %
% 	winglet.taper = 0.4;				%winglet taper
% 	winglet.sw = 30;				%winglet leading edge sweep angle
